                    ...
                    <tbody>
                      <tr>
                        <td width="130" style="padding-right:10px;">
                          <a href="https://itunes.apple.com/us/app/id374165361?mt=8" target="_blank"><img src="http://media.sailthru.com/53p/1jz/a/e/561ebac54feca.png" width="130" height="40" style="display: block; color: #666666; font-family: Helvetica, arial, sans-serif; font-size: 13px; width: 130px; height: 40px;" alt="TaskRabbit in the AppStore" border="0"></a>
                        </td>
            ...
            <tbody>
              <tr>
                <td align="center" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                  <span class="appleFooter" style="color:#666666;">TaskRabbit - San Francisco, CA</span><br><a href="#" class="original-only" style="color: #666666; text-decoration: none;" target="_blank">Unsubscribe</a>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;<a href="https://support.taskrabbit.com/hc/en-us" class="original-only" style="color: #666666; text-decoration: none;" target="_blank">Support</a><span class="original-only" style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</span><a href="https://www.taskrabbit.com/privacy" style="color: #666666; text-decoration: none;" target="_blank">Privacy Policy</a>
                </td>
              </tr>
            </tbody>
          </table>
